...
smoke also requires a `focus` or `conversation` production bubble from that live
thread context before it captures the exact production window and inspects the
transparent pet-and-bubble surface.
