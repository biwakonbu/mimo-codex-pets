...
grep -Fq 'ご主人、「Mimo runtime QA」は吹き出し要約をツールで確認中です' "$PRESENTATION_LOG"
grep -Fq 'ご主人、「Mimo runtime QA」は吹き出し要約の返答中です' "$PRESENTATION_LOG"
grep -Fq 'ご主人、「Mimo runtime QA」は吹き出し要約の計画中です' "$PRESENTATION_LOG"
grep -Fq 'ご主人、「Mimo runtime QA」は吹き出し要約のコマンドを実行中です' "$PRESENTATION_LOG"
grep -Fq 'ご主人、「Mimo runtime QA」は吹き出し要約の端末入力を確認中です' "$PRESENTATION_LOG"
grep -Fq 'ご主人、「Mimo runtime QA」は吹き出し要約の差分確認中です' "$PRESENTATION_LOG"
