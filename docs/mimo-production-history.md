...
- `script/inspect_accessibility_surface.swift` checks the running app's macOS
  ...
  requires the multi-thread stack to expose several static text nodes plus the
  overflow summary from the same surface Computer Use observes
